<?php include('header.php'); ?>
              ...
              <div class="container">
                <div class="row">
                  <div class="col-12 col-lg-6">
                    ...
                    <a href="president.html" class="btn btn-primary py-3 px-5"
                      >More Details</a
                    >
                  </div>
                </div>
          ...
          <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
            ...
            >
              ...
              >
                ...
                >
                  <h1 class="text-white mb-0">45</h1>
          ...
          <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.5s">
            <div class="h-100">
              <h1 class="display-6 mb-5">
                Delhi Gram Panchayat Sangh is an organation who work for delhi ncr
              </h1>
                ...
                <div class="col-sm-6">
                  <div class="d-flex align-items-center">
                    <img
                      ...
                      alt=""
                    />
                    <h5 class="mb-0">All class of people</h5>
                  </div>
                </div>
                <div class="col-sm-6">
                  <div class="d-flex align-items-center">
                    <img
                      ...
                      alt=""
                    />
                    <h5 class="mb-0">Guaranteed Work</h5>
                  </div>
                </div>
              </div>
              <p class="mb-4">
              ...
              <div class="border-top mt-4 pt-4">
                <div class="d-flex align-items-center">
                  <img
                    ...
                    alt=""
                  />
                  <h5 class="mb-0">Call Us: +91 9811 570 416</h5> &nbsp;&nbsp;&nbsp;&nbsp; <a href="president.html" class="btn btn-primary px-3 d-none d-lg-block">President Message</a>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="row g-0 mx-lg-0">
          ...
          <div class="col-lg-6 facts-counter wow fadeIn" data-wow-delay="0.5s">
            <div class="h-100 px-4 pe-lg-0">
              <div class="row g-5">
                <div class="col-sm-6">
                  <h1 class="display-5" data-toggle="counter-up">1700</h1>
                ...
                <div class="col-sm-6">
                  <h1 class="display-5" data-toggle="counter-up">0700</h1>
        ...
        <div class="row g-5">
          <div class="col-lg-6 wow fadeIn" data-wow-delay="0.3s">
            <h1 class="display-6 text-white mb-5">
              Please Feel Free to Contact Us Any Time If You Need....
            </h1>
            ...
            <div class="bg-white rounded p-3">
              <div class="d-flex align-items-center bg-primary rounded p-3">
                <img
                  ...
                  alt=""
                />
                <h5 class="text-white mb-0">Call Us: +91 9811 570 416
</h5>
              </div>
            </div>
          </div>
    ...
    <div class="container-xxl py-5">
      <div class="container">
        ...
        <div class="row g-4">
          <?php
$ret=mysqli_query($conn,"select * from teams order By id asc");
$cnt=1;
while ($row=mysqli_fetch_array($ret)) {
            ...
            <div class="team-item rounded">
              ...
              <div class="team-text text-center bg-white p-4">
                ...
                <div class="d-flex justify-content-center">
                  <a class="btn btn-square btn-light m-1" href="<?=$row['fblink']?>"
                    ><i class="fab fa-twitter"></i
                  ></a>
                  <a class="btn btn-square btn-light m-1" href="<?=$row['twlink']?>"
